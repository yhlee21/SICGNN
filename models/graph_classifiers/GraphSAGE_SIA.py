...
class GraphSAGE_SIA(nn.Module):
    def __init__(self, dim_features, dim_target, config):
        ...
        print ( "[GraphSAGE_SIA.py]######## GraphSAGE_SIA " + str(self.struc_info) + " " + str(self.info_dim) +  " starts  #########" ) 

        ## add structural information for Readout layer of GraphSAGE
        self.fc1 = nn.Linear(num_layers * (dim_embedding - self.info_dim) + self.info_dim, dim_embedding)
    ...
    def forward(self, data):
        ...
        ## add structural information for Readout layer
        x = torch.cat( [x, struc_info_torch], dim=1 )
