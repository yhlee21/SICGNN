...
class GAT_SIA(nn.Module):
    def __init__(self, dim_features, dim_target, config):
        ...
        print ( "[GAT_SIA.py]######## GAT_SIA " + str(self.struc_info) + " " + str(self.info_dim) + " starts  #########" ) 

        self.fc1 = nn.Linear(num_layers * (dim_embedding*self.in_head) + self.info_dim , dim_embedding)
