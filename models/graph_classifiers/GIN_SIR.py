...
class GIN_SIR(torch.nn.Module):

    def __init__(self, dim_features, dim_target, config):
        super(GIN_SIR, self).__init__()
        ...
        print ( "[GIN_SIR.py]######## GIN_SIR " + str(self.struc_info) + " " + str(self.info_dim) + " starts #########" ) 
    ...
    def forward(self, data):
        ...
        for layer in range(self.no_layers):
            if layer == 0:
                ...
                ## add structural information for Readout layer of GIN
