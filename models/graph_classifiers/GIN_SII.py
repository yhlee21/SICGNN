...
class GIN_SII(torch.nn.Module):

    def __init__(self, dim_features, dim_target, config):
        super(GIN_SII, self).__init__()
        ...
        print ( "[GIN_SII.py]######## GIN_SII " + str(self.struc_info) + " " + str(self.info_dim) + " starts #########" ) 
    ...
    def forward(self, data):
        ...
        for layer in range(self.no_layers):
            if layer == 0:
                ...
                ## add structural information for each layer of GIN but not for READOUT layer of GIN
